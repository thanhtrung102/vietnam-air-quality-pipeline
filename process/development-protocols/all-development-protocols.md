...
1. `orchestration.md`
2. `live-state-verification.md`
3. `implementation-standards.md`
4. `plan-lifecycle.md`
5. `phase-programs.md`
6. `parallel-fan-out.md`
7. `intent-clarification.md`
8. `context-maintenance.md`
...
- `live-state-verification.md`
  The HARD GATE: any claim about a deployed system or real data must be settled by a read-only probe against ground truth (not a code-read, not peer-agent agreement) before it enters a plan or a completion claim. Merge-blocking.
